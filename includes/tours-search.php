        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="keyword" class="form-control" placeholder="Type in a keyword" 
                ...
                <div class="col-sm-12 col-md-3">
                    ...
                    <select class="form-select" name="destination" id="">
                        ...
                        <?php foreach ($destinations as $destination) : ?>
                            <option <?php 
                                if (isset($_GET['destination']) && ($_GET['destination'] == $destination->slug)) : ?> 
                                selected <?php endif; ?> value="<?php echo $destination->slug; ?>"><?php echo $destination->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
